...
CREATE POLICY "Allow auth admins ALL" ON "public"."orders" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."group" = 'ADMIN'::"text")))));



CREATE POLICY "Allow authenticated admin to UPDATE" ON "public"."products" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."group" = 'ADMIN'::"text"))))) WITH CHECK (true);



CREATE POLICY "Allow authenticated admins to DELETE" ON "public"."products" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."group" = 'ADMIN'::"text")))));



CREATE POLICY "Allow authenticated user with group ADMIN to INSERT" ON "public"."products" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."group" = 'ADMIN'::"text")))));



CREATE POLICY "Allow authenticated users to SELECT" ON "public"."products" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Enable read for auth users" ON "public"."order_items" FOR SELECT TO "authenticated" USING (true);
